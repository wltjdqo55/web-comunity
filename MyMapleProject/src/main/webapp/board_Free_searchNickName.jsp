				...
				<div class = "center_content">
					...
					<div class = "board_free_Input">
						...
						<div class = "menu_categori_choice">
							...
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_suda.do">수다</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_tupyo.do">투표</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_insa.do">인사</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_smail.do">웃긴글</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_event.do">이벤트</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "board_Free_jungbo.do">정보</a></span><span class = "span_l">|</span>
							<hr>
						</div>
						...
						<c:forEach items="${mylist}" var="mylist">
						      <tr class = "trtrtr">
						        ...
						        <td class = "titleTD">
						        	...
						        	<a href = "board_Free_Content_View.do?num=${mylist.num}&comment=${countValue}">
						        ...
						        <td class="NickNameTD">
								  ...
								  <div class="option1">
								  	<div class = "option1-1">
								  		<a href="Board_Free_NickName_search.do?userNickName=${mylist.userNickName}">이름으로 검색</a>
								  	</div>
								  	<c:if test = "${empty sessionScope.userInfo}">
								  	<div class = "option1-2">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="board_Free_NickName_search.do?curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
