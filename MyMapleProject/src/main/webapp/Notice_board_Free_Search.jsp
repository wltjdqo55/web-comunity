...
background-gradient: rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0) 100%;}
	tr:hover{background-color:#e3e4e6;}
 		/*가운데 div */
 		.container_wrap{ background-color: white;height: auto;}
						...
						<div style = "display:flex;">
							...
							<div style = "float: right; width:30%;">
								...
								<c:if test = "${userInfo ne null }">
									<a href = "Notice_board_free_write.do"><span class = "board_free_write">글쓰기</span></a>
								</c:if>
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice_search_board_Free.do?curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
