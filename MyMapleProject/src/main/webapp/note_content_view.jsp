...
<div class = "container">
	...
	<div class = "container_right_box">
		<div class = "container_right_inner_box">
			...
			<c:set value="${listCC}" var="list" />
			<div class = "fjkjakf">
				<span class = "divleft">${list.userNickName}</span><span class = "divright">${list.wtime}</span>
			</div>
			...
			<table>
				<tr>
					...
					<td class = "second_td">${list.title } </td>
				</tr>
				<tr>
					<td class = "first_td">내용</td>
					<td class = "second_td"><textarea cols="46" rows="12" name = "content" id = "content" readonly >${list.content}</textarea> </td>
				</tr>
			</table>
			<div class = "ddd">
				<span class = "bottom_left"><a href = "note.do">리스트</a></span>
				<span class = "bottom_right"><a href = "note_writingGood.do?userNickName=${list.userNickName}">답장하기</a></span>
			</div>
			</form>
			</div>
		</div>
