		...
		<%-- 가운데 content div --%>
			...
			<%--가운데 DIV --%>
				...
				<div class = "center_content">
					<form action = "Warrior_BoardmodifyOK.do" method = "post" enctype="multipart/form-data">
					<%-- 글쓰기 폼 --%>
					<div class = "center_content_title">
						<div class = "select_left">
							<select name="category">
							  <option value="1" ${dto.category == '분류' ? 'selected' : ''}>분류</option>
							  <option value="2" ${dto.category == '전사' ? 'selected' : ''}>전사</option>
							  <option value="3" ${dto.category == '마법사' ? 'selected' : ''}>마법사</option>
							  <option value="4" ${dto.category == '궁수' ? 'selected' : ''}>궁수</option>
							  <option value="5" ${dto.category == '도적' ? 'selected' : ''}>도적</option>
							  <option value="6" ${dto.category == '해적' ? 'selected' : ''}>해적</option>
							</select>
						</div>
