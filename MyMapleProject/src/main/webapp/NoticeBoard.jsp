				...
				<div class = "center_content">
					...
					<div class = "board_free_Input">
						...
						<div class = "menu_categori_choice">
							...
							<span class = "span_text" id = "span_text_entire"><a href = "Notice1.do?good=1">공지</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_entire"><a href = "Notice1.do?good=2">이벤트</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_entire"><a href = "Notice1.do?good=3">점검</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_entire"><a href = "Notice1.do?good=4">소식</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_entire"><a href = "Notice1.do?good=5">버그제보</a></span><span class = "span_l">|</span>
							<hr>
						</div>
						<c:if test = "${IZ eq '0'}">
							...
							<c:forEach items="${list}" var="item">
						      <tr class = "trtrtr">
						        ...
						        <td class = "titleTD">
						        	...
						        	<a href = "Notice_board_Free_Content_View.do?num=${item.num}&comment=${countValue}">
						        		<c:out value="[${item.category}]" /> 
						       ...
						       <td class="NickNameTD">
								  ...
								  <div class="option1">
								  	<div class = "option1-1">
								  		 <a href="Notice_Board_Free_NickName_search.do?userNickName=${item.userNickName}">이름으로 검색</a>
								  	</div>
								  	<c:if test = "${empty sessionScope.userInfo}">
								  	<div class = "option1-2">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
				...
				<c:if test = "${IZ eq '1'}">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?good=1&curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
				...
				<c:if test = "${IZ eq '2'}">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?good=2&curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
				...
				<c:if test = "${IZ eq '3'}">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?good=3&curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
				...
				<c:if test = "${IZ eq '4'}">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?good=4&curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
				...
				<c:if test = "${IZ eq '5'}">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Notice.do?good=5&curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
