				...
				<div class = "center_content">
					...
					<div class = "board_free_Input">
						...
						<div class = "menu_categori_choice">
							...
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=3">궁수</a></span><span class = "span_l">|</span>
						...
						<div class = "menu_list_table_div">
							...
							<c:forEach items="${list}" var="item">
						      <tr class = "trtrtr">
						        ...
						        <td class = "titleTD">
						        	...
						        	<c:choose>
									    <c:when test="${not empty item.img_file}">
							...
							<div>
								<a href = "Warrior.do"><span class = "board_free_list">목록</span></a>
								<c:if test = "${userInfo ne null }">
									<a href = "Warrior_board_free_write.do"><span class = "board_free_write">글쓰기</span></a>
								</c:if>
								<c:if test = "${userInfo eq null }">
									<span class = "board_free_write" id = "board_free_write_no">글쓰기</span>
								</c:if>
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Warrior_onetwo_Board.do?curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
