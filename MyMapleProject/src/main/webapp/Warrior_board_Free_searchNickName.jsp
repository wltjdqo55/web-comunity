				...
				<div class = "center_content">
					...
					<div class = "board_free_Input">
						...
						<div class = "menu_categori_choice">
							<span class = "span_text" id = "span_text_entire"><a href = "Warrior.do?good=0">전체</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=1">전사</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=2">마법사</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=3">궁사</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=4">도적</a></span><span class = "span_l">|</span>
							<span class = "span_text" id = "span_text_good"><a href = "Warrior.do?good=5">해적</a></span><span class = "span_l">|</span>
							<hr>
						</div>
						...
						<c:forEach items="${mylist}" var="mylist">
						      <tr class = "trtrtr">
						        ...
						        <td class = "titleTD">
						        	...
						        	<a href = "Warrior_board_Free_Content_View.do?num=${mylist.num}&comment=${countValue}">
						        ...
						        <td class="NickNameTD">
								  ...
								  <div class="option1">
								  	<div class = "option1-1">
								  		<a href="Warrior_Board_Free_NickName_search.do?userNickName=${mylist.userNickName}">이름으로 검색</a>
								  	</div>
								  	<c:if test = "${empty sessionScope.userInfo}">
								  	<div class = "option1-2">
						...
						<c:forEach var="i" begin="0" end="${totalPage}" step="1">
							<c:choose>
								...
								<c:when test="${i ne curPage}">
									<a href="Warrior_board_Free_NickName_search.do?curPage=${i}">${i+1}</a>
								</c:when>
							</c:choose> 		
						</c:forEach>
