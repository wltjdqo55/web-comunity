...
public class NoticeBoardDAO {
	...
	private final String INSA_LIST_FREE_BOARD_SQL  = "select * from " + TABLE_NAME + " where category = '점검' order by num desc LIMIT ?, ?";
	private final String SMAIL_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '소식' order by num desc LIMIT ?, ?";
	private final String SUDA_LIST_FREE_BOARD_SQL  = "select * from " + TABLE_NAME + " where category = '공지' order by num desc LIMIT ?, ?";
	private final String TUPYO_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '이벤트' order by num desc LIMIT ?, ?";
	private final String EVENT_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '버그제보' order by num desc LIMIT ?, ?";
	...
	private final String INSA_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '점검'";
	private final String SMAIL_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '소식'";
	private final String SUDA_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '공지'";
	private final String TUPYO_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '이벤트'";
	private final String EVENT_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '버그제보'";	
	...
	private final String MY_COMMENT_BOARD_SQL = "SELECT * FROM NoticeBoard WHERE num IN (SELECT Num FROM reply WHERE replyId = ?) ORDER BY num DESC LIMIT ?, ?";
	private final String BNUM_CHECK = "SELECT COUNT(*) FROM Noticereply WHERE Num = ?";
	...
	public static NoticeBoardDAO getWarriorBoardDAO() {
	...
	// 관리자 //
	//컨텐츠 뷰 가져오는 메소드
	public NoticeBoardDTO Admin_Content_View(int num) {
	...
	public ArrayList<NoticeBoardDTO> Admin_Boardcategory_List(int curPage){
	...
	public ArrayList<NoticeBoardDTO> Admin_Wtime_List(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> Admin_Recommend_List(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> Admin_Hit_List(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> SearchNickNameAdmin(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	//제목 + 내용으로 찾는 메소드
	public ArrayList<NoticeBoardDTO> SearchTitleAndContent(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	//게시판으로 찾는 메소드
	public ArrayList<NoticeBoardDTO> Searchboardcategory(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> Admin_FreeBoardListBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> AdminUserNickNameList(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	// 제목 + 닉네임으로 검색
	public ArrayList<NoticeBoardDTO> SearchTitleAndNickName(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	// 제목으로 검색
	public ArrayList<NoticeBoardDTO> SearchTitle(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	// 닉네임으로 검색
	public ArrayList<NoticeBoardDTO> SearchNickName(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();	
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> NextContentView(int nextNum, String Comment) throws IOException{
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		NoticeBoardDTO dto = new NoticeBoardDTO();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<NoticeBoardDTO> PredContentView(int predNum, String Comment){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		NoticeBoardDTO dto = new NoticeBoardDTO();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<NoticeBoardDTO> IndexGoodFreeBoardDAO(){
	    Connection conn = getConnection();
	    PreparedStatement pstmt = null;
	    ResultSet rs = null;
	    ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	    ...
	    // 댓글 개수를 기준으로 내림차순 정렬
//	    list.sort(Comparator.comparingInt(NoticeBoardDTO::getComment).reversed());
...
//	    }
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO1(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		try {
			pstmt = conn.prepareStatement("select * from " + TABLE_NAME + " where category = ? or category = ? order by num desc");
			pstmt.setString(1, "소식");
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO2(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO3(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO4(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public ArrayList<NoticeBoardDTO> IndexFreeBoardDAO5(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public ArrayList<NoticeBoardDTO> SearchNickNameBOARD(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public void FreeBoardModify(NoticeBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<NoticeBoardDTO> board_Free_my_comment(NoticeBoardDTO dto, int curPage) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		try {
			...
			rs = pstmt.executeQuery();
			while(rs.next()) {
				NoticeBoardDTO dtoo = new NoticeBoardDTO();
				int Count = BNUMChk(rs.getInt("num"));
	...
	public ArrayList<NoticeBoardDTO> board_Free_my_writing(NoticeBoardDTO dto, int curPage) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
	...
	public NoticeBoardDTO board_Free_modifyDAO(NoticeBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		NoticeBoardDTO dtoo = new NoticeBoardDTO();
	...
	public void FreeBoardDeleteDAO(NoticeBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		try {
	...
	public void FreeBoardListWrite(NoticeBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public int calTotalPage_MyComment(NoticeBoardDTO dto) {
	...
	public int cntOfList_MyComment(NoticeBoardDTO dto) {
		int cnt = 0;
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;		
	...
	public int calTotalPage_Mylist(NoticeBoardDTO dto) {
	...
	public int cntOfList_Mylist(NoticeBoardDTO dto) {
		int cnt = 0;
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;		
	...
	public ArrayList<NoticeBoardDTO> FreeBoardListBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardEventBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardInsaBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardSmailBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardSudaBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> ThirtyBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> TenBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardTupyoBoard(int curPage){
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<NoticeBoardDTO> FreeBoardContentview(NoticeBoardDTO dto) {
		ArrayList<NoticeBoardDTO> list = new ArrayList<NoticeBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
