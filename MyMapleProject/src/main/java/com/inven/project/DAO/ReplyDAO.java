...
public class ReplyDAO {
	...
	private final String REPLY_WRITE_BOARD_SQL = "insert into reply(num, replytext, replyNickName, replyId, replyPassword, replyName, groupNum) values(?,?,?,?,?,?,?)";
	...
	private final String REPLY_INSERT_BOARD_SQL = "insert into reply(num, replytext, replyNickName, replyId, replyPassword, replyName, groupNum,stepNum) values(?,?,?,?,?,?,?,?)";
//	private final String UPDATE_STEPNUM = "update " + TABLE_NAME + " set stepNum = (stepNum+1) where groupNum = ? stepNum>=?";
	...
	public ArrayList<ReplyDTO> AdminUserComment(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<ReplyDTO> ListreplyDAO(int num){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//				dto.setNum(rs.getInt("num"));
	...
	public void WriteInsert(ReplyDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
//		updateStepNum(dto);
		try {
