...
public class WarriorBoardDAO {
	private static WarriorBoardDAO warriorBoardDAO = new WarriorBoardDAO();
	private String CONNECTION_POOL_RESOURCE_NAME = "jdbc/MyProject";
	private final String TABLE_NAME = "WarriorBoard";
	...
	private final String INSA_LIST_FREE_BOARD_SQL  = "select * from " + TABLE_NAME + " where category = '궁수' order by num desc LIMIT ?, ?";
	private final String JUNGBO_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '정보' order by num desc LIMIT ?, ?";
	private final String SMAIL_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '도적' order by num desc LIMIT ?, ?";
	private final String SUDA_LIST_FREE_BOARD_SQL  = "select * from " + TABLE_NAME + " where category = '전사' order by num desc LIMIT ?, ?";
	private final String TUPYO_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '마법사' order by num desc LIMIT ?, ?";
	private final String EVENT_LIST_FREE_BOARD_SQL = "select * from " + TABLE_NAME + " where category = '해적' order by num desc LIMIT ?, ?";
	...
	private final String INSA_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '궁수'";
	private final String JUNGBO_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '정보'";
	private final String SMAIL_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '도적'";
	private final String SUDA_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '전사'";
	private final String TUPYO_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '마법사'";
	private final String EVENT_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " where category = '해적'";	
	...
	private final String MY_COMMENT_BOARD_SQL = "SELECT * FROM WarriorBoard WHERE num IN (SELECT Num FROM reply WHERE replyId = ?) ORDER BY num DESC LIMIT ?, ?";
	private final String BNUM_CHECK = "SELECT COUNT(*) FROM Warriorreply WHERE Num = ?";
	...
	private final String SEARCH_TITLE_NICKNAME = "SELECT * FROM " + TABLE_NAME + " WHERE category LIKE CONCAT('%', ?, '%') ORDER BY num DESC LIMIT ?, ?";
	private final String SEARCH_TITLE = "SELECT * FROM " + TABLE_NAME + " WHERE userTitle LIKE CONCAT('%', ?, '%') or BoardContent LIKE CONCAT('%', ?, '%') ORDER BY num DESC LIMIT ?, ?";
	private final String SEARCH_NICKNAME = "SELECT * FROM " + TABLE_NAME + " WHERE userNickName LIKE CONCAT('%', ?, '%') ORDER BY num DESC LIMIT ?, ?";
	private final String SEARCH_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " WHERE category LIKE CONCAT('%', ?, '%')";
	private final String SEARCHTITLE_SELECT_COUNT_OF_LIST = "SELECT COUNT(*) FROM " + TABLE_NAME + " WHERE userTitle LIKE CONCAT('%', ?, '%') or BoardContent LIKE CONCAT('%', ?, '%')";
	...
	public static WarriorBoardDAO getWarriorBoardDAO() {
		return warriorBoardDAO;
	}
	...
	// 관리자 //
	//컨텐츠 뷰 가져오는 메소드
	public WarriorBoardDTO Admin_Content_View(int num) {
	...
	public ArrayList<WarriorBoardDTO> Admin_Boardcategory_List(int curPage){
	...
	public ArrayList<WarriorBoardDTO> Admin_Wtime_List(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> Admin_Recommend_List(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> Admin_Hit_List(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> SearchNickNameAdmin(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	//제목 + 내용으로 찾는 메소드
	public ArrayList<WarriorBoardDTO> SearchTitleAndContent(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	//게시판으로 찾는 메소드
	public ArrayList<WarriorBoardDTO> Searchboardcategory(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> Admin_FreeBoardListBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> AdminUserNickNameList(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	// 제목 + 닉네임으로 검색
	public ArrayList<WarriorBoardDTO> SearchTitleAndNickName(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	// 제목으로 검색
	public ArrayList<WarriorBoardDTO> SearchTitle(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	// 닉네임으로 검색
	public ArrayList<WarriorBoardDTO> SearchNickName(String search, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();	
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> NextContentView(int nextNum, String Comment) throws IOException{
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		WarriorBoardDTO dto = new WarriorBoardDTO();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<WarriorBoardDTO> PredContentView(int predNum, String Comment){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		WarriorBoardDTO dto = new WarriorBoardDTO();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<WarriorBoardDTO> IndexGoodFreeBoardDAO(){
	    Connection conn = getConnection();
	    PreparedStatement pstmt = null;
	    ResultSet rs = null;
	    ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	    ...
	    // 댓글 개수를 기준으로 내림차순 정렬
//	    list.sort(Comparator.comparingInt(WarriorBoardDTO::getComment).reversed());
...
//	    }
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO1(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		try {
			pstmt = conn.prepareStatement("select * from " + TABLE_NAME + " where category = ? order by num desc");
			pstmt.setString(1, "전사");
			rs = pstmt.executeQuery();
			while(rs.next()) {
				WarriorBoardDTO dto = new WarriorBoardDTO();
				int Count = BNUMChk(rs.getInt("num"));
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO2(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO3(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO4(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> IndexFreeBoardDAO5(){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> SearchNickNameBOARD(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public void FreeBoardModify(WarriorBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public ArrayList<WarriorBoardDTO> board_Free_my_comment(WarriorBoardDTO dto, int curPage) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public ArrayList<WarriorBoardDTO> board_Free_my_writing(WarriorBoardDTO dto, int curPage) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
	...
	public WarriorBoardDTO board_Free_modifyDAO(WarriorBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		WarriorBoardDTO dtoo = new WarriorBoardDTO();
	...
	public void FreeBoardDeleteDAO(WarriorBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		try {
	...
	public void FreeBoardListWrite(WarriorBoardDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
	...
	public int calTotalPage_Searchboardcategory(String search) {
		...
		int totalPage = numberOfArticles_SearchTitle / sizeOfPage;
		if(numberOfArticles_SearchTitle != 0)
			totalPage = numberOfArticles_SearchTitle % sizeOfPage == 0 ? totalPage-1 : totalPage;
	...
	public int calTotalPage_MyComment(WarriorBoardDTO dto) {
	...
	public int cntOfList_MyComment(WarriorBoardDTO dto) {
		int cnt = 0;
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;		
	...
	public int calTotalPage_Mylist(WarriorBoardDTO dto) {
	...
	public int cntOfList_Mylist(WarriorBoardDTO dto) {
		int cnt = 0;
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;		
	...
	public ArrayList<WarriorBoardDTO> FreeBoardListBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardEventBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardInsaBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardJungboBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardSmailBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardSudaBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> ThirtyBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> TenBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardTupyoBoard(int curPage){
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<WarriorBoardDTO> FreeBoardContentview(WarriorBoardDTO dto) {
		ArrayList<WarriorBoardDTO> list = new ArrayList<WarriorBoardDTO>();
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
