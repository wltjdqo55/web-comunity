...
public class WarriorreplyDAO {
	private static WarriorreplyDAO warriorreplyDAO = new WarriorreplyDAO();
	private String CONNECTION_POOL_RESOURCE_NAME = "jdbc/MyProject";
	private final String TABLE_NAME = "Warriorreply";
	private DataSource dataSource;
	
	private final String REPLY_WRITE_BOARD_SQL = "insert into Warriorreply(num, replytext, replyNickName, replyId, replyPassword, replyName, groupNum) values(?,?,?,?,?,?,?)";
	...
	private final String REPLY_INSERT_BOARD_SQL = "insert into Warriorreply(num, replytext, replyNickName, replyId, replyPassword, replyName, groupNum,stepNum) values(?,?,?,?,?,?,?,?)";
//	private final String UPDATE_STEPNUM = "update " + TABLE_NAME + " set stepNum = (stepNum+1) where groupNum = ? stepNum>=?";
	...
	public static WarriorreplyDAO getReplyDAO() {
		return warriorreplyDAO;
	}
	...
	public ArrayList<WarriorreplyDTO> AdminUserComment(String userNickName, int curPage){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		
		ArrayList<WarriorreplyDTO> list = new ArrayList<WarriorreplyDTO>();
		try {
	...
	public void WriteReply(WarriorreplyDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		int result = GroupNum();
		try {
	...
	public ArrayList<WarriorreplyDTO> ListreplyDAO(int num){
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//				dto.setNum(rs.getInt("num"));
	...
	public void WriteInsert(WarriorreplyDTO dto) {
		Connection conn = getConnection();
		PreparedStatement pstmt = null;
//		updateStepNum(dto);
		try {
...
//	public void updateStepNum(ReplyDTO dto) {
//		Connection conn = getConnection();
//		PreparedStatement pstmt = null;
//		try {
