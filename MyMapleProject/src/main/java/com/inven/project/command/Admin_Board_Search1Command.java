...
public class Admin_Board_Search1Command implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FreeBoardDAO daoo = FreeBoardDAO.getFreeBoardDAO();
		...
		int WarriorCount = dao.AdminBoardCount();
		int NoticeCount = daooo.AdminBoardCount();
		int boardCount = daoo.AdminBoardCount();
