...
public class Warrior_BoardwriteOKCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    dto.setUserPassword(multi.getParameter("userPassword"));
	    dto.setUserNickName(multi.getParameter("userNickName"));
