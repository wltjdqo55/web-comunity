...
public class Admin1_BoardCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<WarriorBoardDTO> list = daoo.Admin_FreeBoardListBoard(curPage);
		int totalPage = daoo.calTotalPageAdmin(curPage);
