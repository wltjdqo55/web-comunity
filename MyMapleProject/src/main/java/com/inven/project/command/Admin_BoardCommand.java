...
public class Admin_BoardCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<FreeBoardDTO> list = dao.Admin_FreeBoardListBoard(curPage);
		int totalPage = dao.calTotalPageAdmin(curPage);
