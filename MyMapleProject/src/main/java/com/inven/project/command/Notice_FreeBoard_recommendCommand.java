...
public class Notice_FreeBoard_recommendCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NoticeBoardDAO daoo = NoticeBoardDAO.getWarriorBoardDAO();
		...
		if(result == 1) {
			...
			script.println("location.href = 'Notice_board_Free_Content_View.do?num=" + bnum + "&comment=" + comment + "'");
			script.println("</script>");
			script.close();
